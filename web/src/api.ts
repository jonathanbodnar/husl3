...
export const api = {
  ...
  runStats: (connection: PostgresConnection | undefined, scoreboard: Scoreboard, only?: string[], ads?: AdDataset | null, noTelemetry?: boolean) => post<{ results: Record<string, StatResult>; computedAt: string; eval: ScoreboardEval }>("/api/stats/run", { connection, scoreboard, only, ads, noTelemetry }),
